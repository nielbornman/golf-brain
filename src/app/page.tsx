...
<section className="py-10">
      ...
      {[
        ...
        >
          <div className="rounded-2xl border border-slate-200/60 bg-slate-50/70 overflow-hidden">
            {/* Use next/image in your file if you prefer; <img> is fine for now */}
  ...
  <div className="mt-4 rounded-3xl border border-slate-200/70 bg-white p-4">
    ...
    <p className="mt-2 text-sm text-slate-700 leading-relaxed">
      Most tools add noise. Golf Brain stays quiet during play, then helps you
      capture the one thing that will compound next time.
    </p>
  </div>
</section>
...
{/* Solution */}
      <Section
        title="Gain the critical insights into your mental game."
        subtitle="A simple dashboard that with critical insights to help you perform at your best when it really matters."
      >
